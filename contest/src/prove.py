...
#starting at 22, its wide.
#wobbling around 250
#farther away it wobbles a lot sooner. 
#50 is probably best.
...
class LoadFeature(object):
    ...
    def camera_callback(self,data):
        ...
        image_1 = cv2.imread('/home/user/catkin_ws/src/cmput412-contest1/contest/src/test_cube.jpg',1)
        image_2 = cv_image
